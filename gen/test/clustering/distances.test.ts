...
const raoValue = rao({ data: [1, 0, 1, 0, 0, 1, 1, 1, 1, 0], name: "" }, { data: [1, 1, 1, 1, 0, 0, 0, 0, 1, 0,], name: "" });
...
const simpleMatchingValue = simpleMatchingCoefficient({ data: [1, 0, 1, 0, 0, 1, 1, 1, 1, 0], name: "" }, { data: [1, 1, 1, 1, 0, 1, 0, 0, 1, 0], name: "" });
